...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for logininEmail widget.
  FocusNode? logininEmailFocusNode;
  TextEditingController? logininEmailTextController;
  String? Function(BuildContext, String?)? logininEmailTextControllerValidator;
  String? _logininEmailTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Email... is required';
    }
  ...
  void initState(BuildContext context) {
    ...
    logininEmailTextControllerValidator = _logininEmailTextControllerValidator;
  ...
  void dispose() {
    ...
    logininEmailFocusNode?.dispose();
    logininEmailTextController?.dispose();
