...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.logininEmailTextController ??= TextEditingController();
    _model.logininEmailFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/qiangs-tasks-high-resolution-logo.png',
                      width: 120.0,
                      fit: BoxFit.contain,
                    ),
                  ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.logininEmailTextController,
                                        focusNode: _model.logininEmailFocusNode,
                                        onChanged: (_) => EasyDebounce.debounce(
                                          '_model.logininEmailTextController',
                                          const Duration(milliseconds: 2000),
                                          () => safeSetState(() {}),
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryText,
                                        validator: _model
                                            .logininEmailTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                    SizedBox(
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            final user = await authManager.signInWithEmail(
                              context,
                              _model.logininEmailTextController.text,
